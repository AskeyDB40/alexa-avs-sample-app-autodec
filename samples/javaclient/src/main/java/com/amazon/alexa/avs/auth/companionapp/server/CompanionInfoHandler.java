...
public class CompanionInfoHandler extends AbstractHandler {
	private static final Logger log = LoggerFactory.getLogger(CompanionInfoHandler.class);
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
			...
			log.info("Wendy: CompanionAppAuthManager --- call exchangeCompanionInfoForTokens");
